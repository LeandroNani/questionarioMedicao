...
\centering
\textbf{Dashboard:}\\
\url{https://dashboardquestionario.streamlit.app/}\\[0.4cm]
\textbf{Repositório:}\\
\url{https://github.com/LeandroNani/questionarioMedicao}

\column{0.35\textwidth}
\centering
\includegraphics[width=\textwidth]{qrcodemedicao.png}
\end{columns}
\end{frame}
