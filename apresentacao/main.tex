...
\end{tabular}
\end{table}
\small{(``Fluente'' dos estudantes consolidado em ``Avançado'' para comparação)}
...
\textbf{Grupo} & \textbf{\%} \\
\midrule
PUC Minas (1ª opção de carreira) & \textbf{48,5\%} \\
Mercado (pretende migrar em $\leq$5 anos) & 26,6\% \\
\bottomrule
\end{tabular}\\[0.3cm]
\normalsize
...
\end{tabular}\\[0.2cm]
\normalsize
Full Stack: convergência exata.\\
ML/IA: super-representado entre estudantes.
\end{block}
\end{columns}
